...
import { authedUser, createProject, getHomeProjects } from "../../redux/actions";
...
export default function CreateProject() {
  ...
  const handleCheck = (event) => {
    ...
    if (arrAux.length > 5) {
      setErrors({ ...errors, category: 'solo se permiten hasta 5 categorias por proyecto' })
      ...
      <div className={style.containerCreateProject}>
        <form onSubmit={submitHandler} className={style.formContainer}>
          ...
          <div className={style.containerQuestionCategory}>
            <h2>Categorías: </h2>
            {errors.category && (<span className={style.danger}>{errors.category}</span>)}
            <div className={style.questionCategory}>
