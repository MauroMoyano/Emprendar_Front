        ...
        <div className={style.bodyContainer}>
          ...
          <div className={style.subMenuContainer}>
            <ul>
              <li>
                <Link href="/users">
                  <FontAwesomeIcon icon={faUsers} className={style.theIcon} />{" "}
                  Usuarios
                </Link>
              </li>
              <li>
                <Link href="/contactUs">
                  <FontAwesomeIcon icon={faPhone} className={style.theIcon} />
                  Contáctanos
                </Link>
              </li>
              <li>
                  ...
                  <section className={style.column}>
                    <div>
                      <label className={style.accordion}>
                        ...
                        >
                          <button
                            className={style.accordion__content_selected}
                            onClick={(e) => setOrden(e.target.value)}
                            value=""
                          >
                            -
                          </button>
                      ...
                      <label className={style.accordion}>
                        <div className={style.accordion__header}>
                          <button
                            type="button"
                            onClick={() => handlerDeleteSearch()}
                          >
                            <FontAwesomeIcon
                              icon={faDeleteLeft}
                              className={style.theIconInvert}
                            />
                            Borrar filtro
                          </button>
                        </div>
              ...
              <div className={style.menuSearch}>
                <input
                  ...
                  type="search"
                  onChange={(e) => {
                    handleInputChange(e), setSearchs(e.target.value);
                  }}
          ...
          {countriess || categoriess ? (
            <div className={style.mensaje_filtros}>
              ...
              proyectos de la categoria = "
              {categoriess || "seleciona una categoria"}"
            </div>
          ) : (
            <div className={style.mensaje_filtros}>
              {" "}
              Puedes mejorar tu busqueda usando los filtros
            </div>
          )}
